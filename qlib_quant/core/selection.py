...
SELECTION_CSV = Path(
    CONFIG.get("paths.selections", "~/Documents/qlib_quant/data/monthly_selections.csv")
).expanduser()
FACTOR_PARQUET = (
    Path(CONFIG.get("paths.qlib_data", "~/Documents/qlib_quant/data/qlib_data/cn_data")).expanduser()
    / "factor_data.parquet"
)
