...
# Load calendar
cal_dir = os.path.expanduser('~/Documents/qlib_quant/data/qlib_data/cn_data/calendars/')
...
inst_dir = os.path.expanduser('~/Documents/qlib_quant/data/qlib_data/cn_data/instruments/')
all_instruments = set()
...
feat_dir = os.path.expanduser('~/Documents/qlib_quant/data/qlib_data/cn_data/features/')
