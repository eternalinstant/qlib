...
from core.qlib_init import _apply_runtime_overrides, _qlib_runtime_overrides

runtime_overrides = _qlib_runtime_overrides()
qlib.init(provider_uri=CONFIG["qlib_data_path"], region=REG_CN, **runtime_overrides)
