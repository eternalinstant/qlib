...
from strategy.producers.predictive_signal import load_predictive_config, train_from_config, _alpha158_feature_map
...
for feat in parquet_candidates:
    ...
    cfg["output"] = {"root": str(SCAN_DIR / f"pq_{feat}")}

    tmp = str(SCAN_DIR / f"pq_{feat}.yaml")
